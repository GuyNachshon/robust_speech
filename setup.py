...
setup(
    ...
    install_requires=[
        "torch>=2.0.0",
        "transformers>=4.20.0",
        "speechbrain @ git+https://github.com/guynachshon/speechbrain.git",
        "audlib @ git+https://github.com/guynachshon/pyaudlib.git",
    ],
    python_requires=">=3.8",
    url="https://github.com/guynachshon/robust_speech",
)
